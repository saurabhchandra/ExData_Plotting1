...
with(data_sub, {
        ...
        plot(Datetime, Global_active_power, type="l", xlab="", ylab="Global Active Power", cex=0.05)        
        ...
        legend("topright", c("Sub_metering_1", "Sub_metering_2", "Sub_metering_3"), lty=1, lwd=2.5, col=c("black", "red", "blue"), cex = 0.5, bty= "n", y.intersp = 0.25)
        
        plot(Datetime, Global_reactive_power, type="l", xlab="datetime", ylab="Global_reactive_power", ylim=c(0, 0.5))        
